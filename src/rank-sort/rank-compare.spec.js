...
describe('rank compare', () => {
  it('returns negative when A level is less than B', () => {
  ...
  it('returns positive when A level is greater than B', () => {
  ...
  it('returns negative when A level is equal to B but score is less', () => {
  ...
  it('returns positive when A level is equal to B but score is greater', () => {
    const rankA = { score: 6, level: 0 };
